class ParkingsController < ApplicationController
  ...
  def create
    ...
    @parking.schedule_id = @schedule.id
  ...
  private
    ...
    def parking_params
      params.require(:parking).permit(:status, :location, :schedule_id)
    end

    def schedule_params
      params.require(:schedule).permit(:status, :start, :end, :parking_id, :booking_id)
end
